      ...
      <div className="md:ml-64 transition-all duration-300">
        ...
        <section className="relative z-10 pt-20 pb-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-7xl mx-auto text-center">
            <div className="inline-flex items-center space-x-2 bg-[#088395]/10 border border-[#088395]/20 rounded-full px-4 py-2 mb-8">
              <Code className="w-5 h-5 text-[#088395]" />
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="flex items-center space-x-2 bg-slate-800/50 backdrop-blur-sm border border-[#088395]/20 rounded-lg px-4 py-2">
                <Star className="w-5 h-5 text-yellow-400" />
                <span className="text-gray-300">Enterprise Ready</span>
              </div>
              <div className="flex items-center space-x-2 bg-slate-800/50 backdrop-blur-sm border border-[#088395]/20 rounded-lg px-4 py-2">
                <Cpu className="w-5 h-5 text-[#088395]" />
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-16">
              <div className="bg-slate-900/50 backdrop-blur-sm border border-[#088395]/20 rounded-xl p-8">
                <h3 className="text-2xl font-bold mb-4 text-[#088395]">
                  Key Features
                </h3>
              ...
              <div className="bg-slate-900/50 backdrop-blur-sm border border-[#088395]/20 rounded-xl p-8">
                <h3 className="text-2xl font-bold mb-4 text-[#09637E]">
                  Architecture
                </h3>
                <div className="space-y-4">
                  <div className="border-l-4 border-[#088395] pl-4">
                    <h4 className="font-semibold text-[#088395]">
                      ASP.NET Core
                    </h4>
                  ...
                  <div className="border-l-4 border-[#09637E] pl-4">
                    <h4 className="font-semibold text-[#09637E]">
                      Kestrel Server
                    </h4>
                    <p className="text-gray-400 text-sm">
                  ...
                  <div className="border-l-4 border-[#7AB2B2] pl-4">
                    <h4 className="font-semibold text-[#7AB2B2]">Middleware</h4>
                    <p className="text-gray-400 text-sm">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {features.map((feature, index) => (
                <div
                  key={index}
                  className="bg-slate-900/50 backdrop-blur-sm border border-[#088395]/20 rounded-xl p-6 hover:border-[#088395]/40 transition-all duration-300 hover:transform hover:scale-105"
                >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="space-y-8">
              {codeExamples.map((example, index) => (
                <div
                  key={index}
                  className="bg-slate-900/50 backdrop-blur-sm border border-[#088395]/20 rounded-xl overflow-hidden"
                >
                  <div className="bg-slate-800/50 px-6 py-4 border-b border-[#088395]/20">
                    <h3 className="text-xl font-bold text-[#088395]">
                      {example.title}
                    </h3>
                  </div>
                  <div className="p-6">
        ...
        >
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div className="bg-slate-900/50 backdrop-blur-sm border border-[#088395]/20 rounded-xl p-8">
                <h3 className="text-2xl font-bold mb-6 text-[#088395]">
                  Prerequisites
                </h3>
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <ArrowRight className="w-5 h-5 text-[#088395]" />
              ...
              <div className="bg-slate-900/50 backdrop-blur-sm border border-[#088395]/20 rounded-xl p-8">
                <h3 className="text-2xl font-bold mb-6 text-[#09637E]">
                  Quick Start Commands
                </h3>
                <div className="space-y-4 font-mono text-sm">
                  <div className="bg-slate-800/50 rounded-lg p-4">
                    <div className="text-[#088395] mb-2">
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <a
                ...
                className="bg-slate-900/50 backdrop-blur-sm border border-[#088395]/20 rounded-xl p-6 hover:border-[#088395]/40 transition-all duration-300 hover:transform hover:scale-105 block"
              >
                <Globe className="w-12 h-12 text-[#088395] mx-auto mb-4" />
              ...
              <a
                ...
                className="bg-slate-900/50 backdrop-blur-sm border border-[#088395]/20 rounded-xl p-6 hover:border-[#088395]/40 transition-all duration-300 hover:transform hover:scale-105 block"
              >
                <Code className="w-12 h-12 text-[#09637E] mx-auto mb-4" />
              ...
              <a
                ...
                className="bg-slate-900/50 backdrop-blur-sm border border-[#088395]/20 rounded-xl p-6 hover:border-[#088395]/40 transition-all duration-300 hover:transform hover:scale-105 block"
              >
                <Star className="w-12 h-12 text-[#7AB2B2] mx-auto mb-4" />
